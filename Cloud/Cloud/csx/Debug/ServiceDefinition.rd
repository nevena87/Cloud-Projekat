...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Cloud" generation="1" functional="0" release="0" Id="c3d5e790-c993-47fe-9180-55ae0073ebc0" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="CloudGroup" generation="1" functional="0" release="0">
      ...
      <settings>
        ...
        <aCS name="HealthMonitoringService:StorageConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/Cloud/CloudGroup/MapHealthMonitoringService:StorageConnectionString" />
          </maps>
        </aCS>
        ...
        <aCS name="HealthStatusService:StorageConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/Cloud/CloudGroup/MapHealthStatusService:StorageConnectionString" />
          </maps>
        </aCS>
        ...
        <aCS name="NotificationService:StorageConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/Cloud/CloudGroup/MapNotificationService:StorageConnectionString" />
          </maps>
        </aCS>
        ...
        <aCS name="RedditService:StorageConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/Cloud/CloudGroup/MapRedditService:StorageConnectionString" />
          </maps>
        </aCS>
      ...
      <channels>
        ...
        <sFSwitchChannel name="SW:NotificationService:health-monitoring">
          <toPorts>
            <inPortMoniker name="/Cloud/CloudGroup/NotificationService/health-monitoring" />
          </toPorts>
        </sFSwitchChannel>
        <sFSwitchChannel name="SW:RedditService:health-monitoring-r">
          <toPorts>
            <inPortMoniker name="/Cloud/CloudGroup/RedditService/health-monitoring-r" />
          </toPorts>
        </sFSwitchChannel>
      </channels>
      <maps>
        ...
        <map name="MapHealthMonitoringService:StorageConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/Cloud/CloudGroup/HealthMonitoringService/StorageConnectionString" />
          </setting>
        </map>
        ...
        <map name="MapHealthStatusService:StorageConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/Cloud/CloudGroup/HealthStatusService/StorageConnectionString" />
          </setting>
        </map>
        ...
        <map name="MapNotificationService:StorageConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/Cloud/CloudGroup/NotificationService/StorageConnectionString" />
          </setting>
        </map>
        ...
        <map name="MapRedditService:StorageConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/Cloud/CloudGroup/RedditService/StorageConnectionString" />
          </setting>
        </map>
      ...
      <components>
        <groupHascomponents>
          <role name="HealthMonitoringService" generation="1" functional="0" release="0" software="D:\Preuzimanja\CLOUD-konacno\Cloud-Projekat\Cloud\Cloud\csx\Debug\roles\HealthMonitoringService" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
              <outPort name="NotificationService:health-monitoring" protocol="tcp">
                <outToChannel>
                  <sFSwitchChannelMoniker name="/Cloud/CloudGroup/SW:NotificationService:health-monitoring" />
                </outToChannel>
              </outPort>
              <outPort name="RedditService:health-monitoring-r" protocol="tcp">
                <outToChannel>
                  <sFSwitchChannelMoniker name="/Cloud/CloudGroup/SW:RedditService:health-monitoring-r" />
                </outToChannel>
              </outPort>
            </componentports>
            <settings>
              ...
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;HealthMonitoringService&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;HealthMonitoringService&quot; /&gt;&lt;r name=&quot;HealthStatusService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;NotificationService&quot;&gt;&lt;e name=&quot;health-monitoring&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;RedditService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;e name=&quot;health-monitoring-r&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
        ...
        <groupHascomponents>
          <role name="HealthStatusService" generation="1" functional="0" release="0" software="D:\Preuzimanja\CLOUD-konacno\Cloud-Projekat\Cloud\Cloud\csx\Debug\roles\HealthStatusService" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
            ...
            <settings>
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
              <aCS name="StorageConnectionString" defaultValue="" />
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;HealthStatusService&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;HealthMonitoringService&quot; /&gt;&lt;r name=&quot;HealthStatusService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;NotificationService&quot;&gt;&lt;e name=&quot;health-monitoring&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;RedditService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;e name=&quot;health-monitoring-r&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
              <resourceReference name="DiagnosticStore" defaultAmount="[4096,4096,4096]" defaultSticky="true" kind="Directory" />
              <resourceReference name="EventStore" defaultAmount="[1000,1000,1000]" defaultSticky="false" kind="LogStore" />
        ...
        <groupHascomponents>
          <role name="NotificationService" generation="1" functional="0" release="0" software="D:\Preuzimanja\CLOUD-konacno\Cloud-Projekat\Cloud\Cloud\csx\Debug\roles\NotificationService" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
            ...
            <settings>
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
              <aCS name="StorageConnectionString" defaultValue="" />
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;NotificationService&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;HealthMonitoringService&quot; /&gt;&lt;r name=&quot;HealthStatusService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;NotificationService&quot;&gt;&lt;e name=&quot;health-monitoring&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;RedditService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;e name=&quot;health-monitoring-r&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
              <resourceReference name="DiagnosticStore" defaultAmount="[4096,4096,4096]" defaultSticky="true" kind="Directory" />
              <resourceReference name="EventStore" defaultAmount="[1000,1000,1000]" defaultSticky="false" kind="LogStore" />
        ...
        <groupHascomponents>
          <role name="RedditService" generation="1" functional="0" release="0" software="D:\Preuzimanja\CLOUD-konacno\Cloud-Projekat\Cloud\Cloud\csx\Debug\roles\RedditService" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
              <inPort name="Endpoint1" protocol="http" portRanges="80" />
              <inPort name="health-monitoring-r" protocol="tcp" />
              <outPort name="NotificationService:health-monitoring" protocol="tcp">
                <outToChannel>
                  <sFSwitchChannelMoniker name="/Cloud/CloudGroup/SW:NotificationService:health-monitoring" />
                </outToChannel>
            ...
            <settings>
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
              <aCS name="StorageConnectionString" defaultValue="" />
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;RedditService&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;HealthMonitoringService&quot; /&gt;&lt;r name=&quot;HealthStatusService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;NotificationService&quot;&gt;&lt;e name=&quot;health-monitoring&quot; /&gt;&lt;/r&gt;&lt;r name=&quot;RedditService&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;e name=&quot;health-monitoring-r&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
              <resourceReference name="DiagnosticStore" defaultAmount="[4096,4096,4096]" defaultSticky="true" kind="Directory" />
              <resourceReference name="EventStore" defaultAmount="[1000,1000,1000]" defaultSticky="false" kind="LogStore" />
  ...
  <implements>
    <implementation Id="69cc1cc9-47e0-4162-abd8-00a072697e9f" ref="Microsoft.RedDog.Contract\ServiceContract\CloudContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="89d81ca5-520a-4c9c-aa07-1b65b94160ea" ref="Microsoft.RedDog.Contract\Interface\HealthStatusService:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Cloud/CloudGroup/HealthStatusService:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="d50ad627-d06f-45d3-83f4-9899f4916ad4" ref="Microsoft.RedDog.Contract\Interface\RedditService:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Cloud/CloudGroup/RedditService:Endpoint1" />
          </inPort>
        </interfaceReference>
